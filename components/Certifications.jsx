...
export default function Certifications() {
    ...
    const badgeColor = () => 'bg-gray-500 dark:bg-gray-600'
                        ...
                        {professional.map((cert, idx) => (
                            ...
                            >
                                ...
                                <div className="p-5 flex items-start gap-4">
                                    {/* IBM-style icon */}
                                    <div className="w-10 h-10 flex-shrink-0 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-700">
                                ...
                                {standalone.map((cert, idx) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            {cert.description && (
                                                <div className="text-[11px] text-gray-500 dark:text-gray-400 font-medium mt-0.5">{cert.description}</div>
                                            )}
                                            <CertLinks cert={cert} />
                                        </div>
                                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {awards.map((award, idx) => (
                            ...
                            >
                                ...
                                <span className="text-[11px] font-semibold text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded-full border border-gray-200 dark:border-gray-700">
                                    {award.year}
                                </span>
                            </motion.div>
                        ))}
